...
Retail sales analysis project based only on 2025 sales data.
...
Prepare and validate data  using PostgreSQL, then build analytical views for Power BI. Develop a dashboard that answers key business questions: 
